...
# Secret Key from .env
SECRET_KEY = os.getenv('SECRET_KEY', 'your-fallback-dev-secret-key')

# Debug flag from .env (string to bool)
...
# Database configuration - using SQLite (from DATABASE_URL if needed)
DATABASES = {
    'default': {
